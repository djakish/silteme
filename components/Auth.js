  ...
  return (
    <div className="flex justify-center items-center h-screen">
      <div className="col-6 form-widget">
        <h1 className="text-3xl font-bold	 text-white">Supabase + Next.js, Linktree clone</h1>
        <p className="text-lg font-thin	 text-white pt-2">Sign in via magic link with your email below</p>
        <div>
          <input
